...
<div class="container-fluid-copertina paddding mb-5">
    <div class="row mx-0">
        <div class="col-md-6 col-12 paddding animate-box" data-animate-effect="fadeIn">
            <div class="fh5co_suceefh5co_height"><img src="/storage/{{$news->firstFiveNews()[4]->foto}}" alt="img"/>
                <div class="fh5co_suceefh5co_height_position_absolute"></div>
                <div class="fh5co_suceefh5co_height_position_absolute_font">
                    <div class=""><a href="#" class="color_fff"> <i class="fa fa-clock-o"></i>&nbsp;&nbsp;
                        </a></div>
                    <div class=""><a href="/journal/{{$news->firstFiveNews()[4]->id}}" class="fh5co_good_font"> "{{$news->firstFiveNews()[4]->titolo}}" </a></div>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="row">
                <div class="col-md-6 col-6 paddding animate-box" data-animate-effect="fadeIn">
                    <div class="fh5co_suceefh5co_height_2"><img src="/storage/{{$news->firstFiveNews()[3]->foto}}" alt="img"/>
                        <div class="fh5co_suceefh5co_height_position_absolute"></div>
                        <div class="fh5co_suceefh5co_height_position_absolute_font_2">
                            <div class=""><a href="#" class="color_fff"> <i class="fa fa-clock-o"></i>&nbsp;&nbsp;Oct
                                    28,2017 </a></div>
                            <div class=""><a href="/journal/{{$news->firstFiveNews()[3]->id}}" class="fh5co_good_font_2"> "{{$news->firstFiveNews()[3]->titolo}}" </a></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-6 paddding animate-box" data-animate-effect="fadeIn">
                    <div class="fh5co_suceefh5co_height_2"><img src="/storage/{{$news->firstFiveNews()[2]->foto}}" alt="img"/>
                        <div class="fh5co_suceefh5co_height_position_absolute"></div>
                        <div class="fh5co_suceefh5co_height_position_absolute_font_2">
                            <div class=""><a href="#" class="color_fff"> <i class="fa fa-clock-o"></i>&nbsp;&nbsp;Oct 28,2017 </a></div>
                            <div class=""><a href="/journal/{{$news->firstFiveNews()[2]->id}}" class="fh5co_good_font_2"> {{$news->firstFiveNews()[2]->titolo}} </a></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-6 paddding animate-box" data-animate-effect="fadeIn">
                    <div class="fh5co_suceefh5co_height_2"><img src="/storage/{{$news->firstFiveNews()[1]->foto}}" alt="img"/>
                        <div class="fh5co_suceefh5co_height_position_absolute"></div>
                        <div class="fh5co_suceefh5co_height_position_absolute_font_2">
                            <div class=""><a href="#" class="color_fff"> <i class="fa fa-clock-o"></i>&nbsp;&nbsp;Oct
                                    28,2017 </a></div>
                            <div class=""><a href="/journal/{{$news->firstFiveNews()[1]->id}}" class="fh5co_good_font_2"> {{$news->firstFiveNews()[1]->titolo}} </a></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-6 paddding animate-box" data-animate-effect="fadeIn">
                    <div class="fh5co_suceefh5co_height_2"><img src="/storage/{{$news->firstFiveNews()[0]->foto}}" alt="img"/>
                        <div class="fh5co_suceefh5co_height_position_absolute"></div>
                        <div class="fh5co_suceefh5co_height_position_absolute_font_2">
                            <div class=""><a href="#" class="color_fff"> <i class="fa fa-clock-o"></i>&nbsp;&nbsp;Oct
                                    28,2017 </a></div>
                            <div class=""><a href="/journal/{{$news->firstFiveNews()[0]->id}}" class="fh5co_good_font_2"> {{$news->firstFiveNews()[0]->titolo}} </a></div>
                        </div>
                    </div>
                </div>
            </div>
